...
public class SystemBarTintManager {
    ...
    public SystemBarTintManager(Context context, Window win) {
        ...
        mConfig = new SystemBarConfig(context, mStatusBarAvailable, mNavBarAvailable);
    ...
    public static class SystemBarConfig {
        ...
        private SystemBarConfig(Context activity, boolean translucentStatusBar, boolean traslucentNavBar) {
